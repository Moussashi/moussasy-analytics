  ...
  <div id="skills-section">
    <div class="container">
      ...
      <!-- HTML -->
        ...
        <div class="container">
      <h1>Data related skills</h1>
      <!-- Python -->
        <div class="skill-box">
            <span class="title">Python / Panda</span>
            <div class="skill-bar">
        ...
        <!-- GA4 -->
        <div class="skill-box">
            <span class="title">Google analytics 4</span>
            <div class="skill-bar">
                <span class="skill-per ga4">
